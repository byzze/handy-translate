...
import './style.css';
import { WindowGetSize, WindowSetSize, WindowUnmaximise, WindowMaximise } from '../../../wailsjs/runtime'
...
export default function Home() {
    ...
    return (
        <>
            < Card
                shadow='none'
                className={`${transparent ? 'bg-background/90' : 'bg-content1'
                    } float-left w-[200px] h-screen rounded-none ${osType === 'Linux' && 'rounded-l-[10px] border-1'
            ...
            >
                ...
                <Divider />
                <div
                    className={`p-[10px] overflow-y-auto ${osType === 'Linux' ? 'h-[calc(100vh-38px)]' : 'h-[calc(100vh-36px)]'
                        }`}
                >
                    {page}
                </div>
